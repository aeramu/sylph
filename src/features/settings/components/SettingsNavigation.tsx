...
export type SettingsSection = 'projects' | 'provider' | 'git' | 'skills' | 'extensions';
...
export default function SettingsNavigation(props: { active: SettingsSection; onSelect: (section: SettingsSection) => void; onClose: () => void }) {
  const sections: Array<[SettingsSection, string]> = [['projects', 'Projects'], ['provider', 'Provider'], ['git', 'Git'], ['skills', 'Skills'], ['extensions', 'Extensions']];
