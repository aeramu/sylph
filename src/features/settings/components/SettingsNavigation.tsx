...
export type SettingsSection = 'provider' | 'git' | 'skills' | 'extensions';
...
export default function SettingsNavigation(props: { active: SettingsSection; onSelect: (section: SettingsSection) => void; onClose: () => void }) {
  const sections: Array<[SettingsSection, string]> = [['provider', 'Provider'], ['git', 'Git'], ['skills', 'Skills'], ['extensions', 'Extensions']];
