...
vi.mock("../sessions/workspace/workspaceBindingRepository.ts", () => ({
...
const { ensureSessionArtifacts } = await import("./artifactStore.ts");
const { registerArtifactRoutes } = await import("./artifactRoutes.ts");
const { registerFilesystemRoutes } = await import("../filesystem/filesystemRoutes.ts");
