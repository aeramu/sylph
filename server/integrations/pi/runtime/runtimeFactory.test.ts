...
import { askUserQuestionExtensionPath, schedulerExtensionPath, showArtifactExtensionPath } from "./runtimeFactory.ts";
...
describe("runtime extension locations", () => {
  it("points to existing built-in extension modules", () => {
    ...
    expect(fs.existsSync(schedulerExtensionPath)).toBe(true);
